			...
			<div class="col-md-12">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page"><?= Yii::t('common', 'Video gallery') ?></li>
					</ol>
				</nav>
			</div>
			<div class="col-12">
				<h1><?= Yii::t('common', 'Video gallery') ?></h1>
			</div>
		</div>
		<div class="row">
			<?php foreach ($videos as $item): ?>
				<div class="col-lg-4 col-md-4 col-sm-6 mt-2">
					<a href="<?= Url::to(['site/video-view', 'id' => $item->r_id, 'slug' => HelperComponent::getUrl($item->title)]) ?>" class="text-decoration-none">
						<div class="card">
