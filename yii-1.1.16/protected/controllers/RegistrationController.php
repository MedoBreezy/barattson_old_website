...
{
    public $pageTitle = 'CBE Online Registration | Barattson';
    
    public $pageUrl = 'http://barattson.com/payment/registration/create';
	...
	{
	    $this->redirect('http://sms.barattson.com/Exam/ExamRegistration.aspx?type=cbe', 302);
		...
		if(isset($_POST['Registr']))
		{
            ...
            $model->fab_date = date('d-m-Y / H:i', strtotime($model->fab_date));
            $model->fma_date = date('d-m-Y / H:i', strtotime($model->fma_date));
            $model->ffa_date = date('d-m-Y / H:i', strtotime($model->ffa_date));
            $model->glo_date = date('d-m-Y / H:i', strtotime($model->glo_date));
            $model->eng_date = date('d-m-Y / H:i', strtotime($model->eng_date));
            $model->fa_one_date = date('d-m-Y / H:i', strtotime($model->fa_one_date));
            $model->ma_one_date = date('d-m-Y / H:i', strtotime($model->ma_one_date));
            $model->fa_two_date = date('d-m-Y / H:i', strtotime($model->fa_two_date));
            $model->ma_two_date = date('d-m-Y / H:i', strtotime($model->ma_two_date));
		}

		if(!isset($model->fab_date)) $model->fab_date = date('d-m-Y / 00:00', time());
		if(!isset($model->fma_date)) $model->fma_date = date('d-m-Y / 00:00', time());
		if(!isset($model->ffa_date)) $model->ffa_date = date('d-m-Y / 00:00', time());
		if(!isset($model->glo_date)) $model->glo_date = date('d-m-Y / 00:00', time());
		if(!isset($model->eng_date)) $model->eng_date = date('d-m-Y / 00:00', time());
		if(!isset($model->fa_one_date)) $model->fa_one_date = date('d-m-Y / 00:00', time());
		if(!isset($model->ma_one_date)) $model->ma_one_date = date('d-m-Y / 00:00', time());
		if(!isset($model->fa_two_date)) $model->fa_two_date = date('d-m-Y / 00:00', time());
		if(!isset($model->ma_two_date)) $model->ma_two_date = date('d-m-Y / 00:00', time());
