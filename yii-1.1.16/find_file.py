...
for root, directories, filenames in os.walk('/var/www/yii-1.1.16'):
    for filename in filenames:
        if filename.endswith(".php"):
            ...
            if filedata:
                 count_edited+=1 if pat in filedata else 0
                 filedata = filedata.replace(pat, '')
